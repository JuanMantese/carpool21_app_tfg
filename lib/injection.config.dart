...
import 'package:carpool_21_app/src/data/dataSource/remote/services/users_service.dart'
    as _i7;
import 'package:carpool_21_app/src/di/appModule.dart' as _i35;
...
import 'package:socket_io_client/socket_io_client.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.CardsService>(() => appModule.cardsService);
    gh.factory<_i10.DriversPositionService>(
        () => appModule.driversPositionService);
    gh.factory<_i11.DriverTripRequestsService>(
        () => appModule.driverTripRequestsService);
    gh.factory<_i12.PassengerRequestsService>(
        () => appModule.passengerRequestsService);
    gh.factory<_i13.ReserveService>(() => appModule.reserveService);
    gh.factory<_i14.Socket>(() => appModule.socket);
    gh.factory<_i15.AuthRepository>(() => appModule.authRepository);
    gh.factory<_i16.AuthUseCases>(() => appModule.authUseCases);
    gh.factory<_i17.UsersRepository>(() => appModule.usersRepository);
    gh.factory<_i18.UserUseCases>(() => appModule.userUseCases);
    gh.factory<_i19.GeolocationRepository>(
        () => appModule.geolocationRepository);
    gh.factory<_i20.GeolocationUseCases>(() => appModule.geolocationUseCases);
    gh.factory<_i21.CarInfoRepository>(() => appModule.carInfoRepository);
    gh.factory<_i22.CarInfoUseCases>(() => appModule.carInfoUseCases);
    gh.factory<_i23.CardsRepository>(() => appModule.cardsRepository);
    gh.factory<_i24.CardsUseCases>(() => appModule.cardsUseCases);
    gh.factory<_i25.DriverPositionRepository>(
        () => appModule.driverPositionRepository);
    gh.factory<_i26.DriversPositionUseCases>(
        () => appModule.driversPositionUseCases);
    gh.factory<_i27.DriverTripRequestsRepository>(
        () => appModule.driverTripRequestsRepository);
    gh.factory<_i28.DriverTripRequestsUseCases>(
        () => appModule.driverTripRequestsUseCases);
    gh.factory<_i29.PassengerRequestRepository>(
        () => appModule.passengerRequestRepository);
    gh.factory<_i30.PassengerRequestsUseCases>(
        () => appModule.passengerRequestsUseCases);
    gh.factory<_i31.ReserveRepository>(() => appModule.reserveRepository);
    gh.factory<_i32.ReserveUseCases>(() => appModule.reserveUseCases);
    gh.factory<_i33.SocketRepository>(() => appModule.socketRepository);
    gh.factory<_i34.SocketUseCases>(() => appModule.socketUseCases);
    return this;
  }
}
