...
class TripsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [ 
          // Permite listar los viajes del Conductor - CurrentTrip, FutureTrips, HistoricalTrips
                  ...
                  if (state.tripsAll!.futureTrips.isNotEmpty)
                    Column(
                      ...
                      children: [
                        ...
                        ...state.tripsAll!.futureTrips.map((reserve) {
                          return Container(
                            padding: const EdgeInsets.symmetric(horizontal: 20),
                    ...
                    if (state.tripsAll!.pastTrips.isNotEmpty)
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Padding(
                          ...
                          ...state.tripsAll!.pastTrips.map((reserve) {
                            return Container(
                              padding: const EdgeInsets.symmetric(horizontal: 20),
